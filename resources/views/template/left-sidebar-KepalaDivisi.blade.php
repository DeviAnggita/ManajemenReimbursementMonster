...
<ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item">
        <a class="nav-link" href="/kepala-divisi/dashboard/">
    ...
    <li class="nav-item">
        <a class="nav-link" href="/kepala-divisi/verifikasi">
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                {{-- <a class="collapse-item" href="/kepala-divisi/menunggu-verifikasi">Menunggu Persetujuan</a> --}}
                <a class="collapse-item" href="/kepala-divisi/setuju-verifikasi">Disetujui</a>
                <a class="collapse-item" href="/kepala-divisi/revisi-verifikasi">Perlu Revisi</a>
                <a class="collapse-item" href="/kepala-divisi/tolak-verifikasi">Ditolak</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="/kepala-divisi/medical-verifikasi">Medical</a>
                <a class="collapse-item" href="/kepala-divisi/perjalanan-bisnis-verifikasi">Perjalanan Bisnis</a>
                <a class="collapse-item" href="/kepala-divisi/penunjang-kantor-verifikasi">Penunjang Kantor</a>
            </div>
        </div>
    </li>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const dashboardLink = document.querySelector(".nav-item .nav-link[href='/kepala-divisi/dashboard/']");
        const verifikasiLink = document.querySelector(".nav-item .nav-link[href='/kepala-divisi/verifikasi']");
        ...
        const menungguVerifikasiSubMenu = document.querySelector(
            ".collapse-item[href='/kepala-divisi/menunggu-verifikasi']");
        const setujuVerifikasiSubMenu = document.querySelector(
            ".collapse-item[href='/kepala-divisi/setuju-verifikasi']");
        const revisiVerifikasiSubMenu = document.querySelector(
            ".collapse-item[href='/kepala-divisi/revisi-verifikasi']");
        const tolakVerifikasiSubMenu = document.querySelector(
            ".collapse-item[href='/kepala-divisi/tolak-verifikasi']");
        ...
        const medicalVerifikasiSubMenu = document.querySelector(
            ".collapse-item[href='/kepala-divisi/medical-verifikasi']");
        const perjalananBisnisVerifikasiSubMenu = document.querySelector(
            ".collapse-item[href='/kepala-divisi/perjalanan-bisnis-verifikasi']");
        const penunjangKantorVerifikasiSubMenu = document.querySelector(
            ".collapse-item[href='/kepala-divisi/penunjang-kantor-verifikasi']");
