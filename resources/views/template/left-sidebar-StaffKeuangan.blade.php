<style>
    ...
    .navbar-nav.btn-success:hover {
        background-color: #189E6F;
        /* Add any additional styles you want for the btn-success class here */
    }

    /* If you want to change the background color for the sidebar */
    .sidebar {
        background-color: #189E6F;
    }
</style>
...
<ul class="navbar-nav btn-success sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item">
        <a class="nav-link" href="/staff-keuangan/dashboard/">
    ...
    <li class="nav-item">
        <a class="nav-link" href="/staff-keuangan/verifikasi">
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                {{-- <a class="collapse-item" href="/staff-keuangan/belum-terbayar">Belum Terbayar</a> --}}
                <a class="collapse-item" href="/staff-keuangan/sudah-terbayar">Sudah Terbayar</a>
                <a class="collapse-item" href="/staff-keuangan/selesai-reimbursement">Selesai</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="/staff-keuangan/medical-verifikasi">Medical</a>
                <a class="collapse-item" href="/staff-keuangan/perjalanan-bisnis-verifikasi">Perjalanan Bisnis</a>
                <a class="collapse-item" href="/staff-keuangan/penunjang-kantor-verifikasi">Penunjang Kantor</a>
            </div>
        </div>
    </li>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const dashboardLink = document.querySelector(
            ".nav-item .nav-link[href='/staff-keuangan/dashboard/']");
        const verifikasiLink = document.querySelector(
            ".nav-item .nav-link[href='/staff-keuangan/verifikasi']");
        ...
        const belumTerbayarSubMenu = document.querySelector(
            ".collapse-item[href='/staff-keuangan/belum-terbayar']");
        const sudahTerbayarSubMenu = document.querySelector(
            ".collapse-item[href='/staff-keuangan/sudah-terbayar']");
        const selesaiReimbursementSubMenu = document.querySelector(
            ".collapse-item[href='/staff-keuangan/selesai-reimbursement']");


        const collapseInner = document.querySelector(".bg-white.py-2.collapse-inner.rounded");

        if (belumTerbayarSubMenu && belumTerbayarSubMenu.href === currentLocation) {
            collapsePages.classList.add("show");
            belumTerbayarSubMenu.classList.add("active");
            collapseInner.style.display = "block";

            // Remove active class from parent nav-item if any
            const parentNavItem = belumTerbayarSubMenu.closest(".nav-item");
        ...
        } else if (sudahTerbayarSubMenu && sudahTerbayarSubMenu.href === currentLocation) {
            collapsePages.classList.add("show");
            sudahTerbayarSubMenu.classList.add("active");
            collapseInner.style.display = "block";

            // Remove active class from parent nav-item if any
            const parentNavItem = sudahTerbayarSubMenu.closest(".nav-item");
            const parentNavItems = document.querySelectorAll(".nav-item");
            parentNavItems.forEach(function(item) {
                item.classList.remove("active");
            });
        ...
        const medicalVerifikasiSubMenu = document.querySelector(
            ".collapse-item[href='/staff-keuangan/medical-verifikasi']");
        const perjalananBisnisVerifikasiSubMenu = document.querySelector(
            ".collapse-item[href='/staff-keuangan/perjalanan-bisnis-verifikasi']");
        const penunjangKantorVerifikasiSubMenu = document.querySelector(
            ".collapse-item[href='/staff-keuangan/penunjang-kantor-verifikasi']");
