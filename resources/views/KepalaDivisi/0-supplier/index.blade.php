...
<head>
    ...
    <title>Kepala Divisi - Data Supplier</title>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                @include('KepalaDivisi.supplier.create')
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                ...
                                                {{-- MODAL SHOW SUPPLIER --}}
                                                @include('KepalaDivisi.supplier.show')
                                                ...
                                                @include('KepalaDivisi.supplier.update')
                                                ...
                                                @include('KepalaDivisi.supplier.delete')
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
