...
<head>
    ...
    <title>Kepala Divisi - Data Lampiran</title>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                @include('KepalaDivisi.lampiran.create')
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                ...
                                                {{-- MODAL SHOW SUPPLIER --}}
                                                @include('KepalaDivisi.lampiran.show')
                                                ...
                                                @include('KepalaDivisi.lampiran.update')
                                                ...
                                                @include('KepalaDivisi.lampiran.delete')
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
