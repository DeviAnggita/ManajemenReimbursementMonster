...
<head>
    ...
    <title>Data Verifikasi Reimbursement Medical</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    {{-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/kepala-divisi/medical-export-excel"
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            <div class="row mb-3">
                                <div class="col">
                                    <h2 class="h5 mb-0 text-gray-800">Reimbursement Medical -
                                        {{ $tahun_terpilih }}
                                    </h2>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('medical-verifikasi-kd.index') }}"
                                        class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/kepala-divisi/medical-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Data Tabel Verifikasi Reimbursement Medical
                            </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTableMedicalKD" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            ...
                                            --}}
                                                <td class="d-flex">
                                                    ...
                                                    @include('KepalaDivisi.medical-verifikasi.showVerifikasi')
                                                    ...
                                                    @if ($reimbursement->id_status_pengajuan_mk === null || $reimbursement->id_status_pengajuan_mk == 41)
                                                        ...
                                                        @include('KepalaDivisi.medical-verifikasi.update')
                                                    @endif
                                                    {{-- SHOW Reimbursement Medical --}}
                                                    <a href="{{ route('medical-verifikasi-kd.show', $reimbursement->id_reimbursement) }}"
