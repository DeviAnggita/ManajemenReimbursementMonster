...
<head>
    ...
    <title>Detail Verifikasi Reimbursement Penunjang Kantor </title>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="font-weight-bold text-gray-900">
                                <a href="/kepala-divisi/penunjang-kantor-verifikasi" class="arrow-link">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control-plaintext mb-1"
                                        ...
                                        value="{{ $reimbursement->nama_jenis_reimbursement }}" readonly>
                                </div>
                            </div>
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control-plaintext mb-1"
                                        aria-describedby="id_reimbursement" name="id_reimbursement"
                                        style="color: #1f1f1f; width: 300px;"
                                        value="{{ $reimbursement->nomor_identitas_karyawan }}" readonly>
                                </div>
                            </div>
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control-plaintext mb-1"
                                        aria-describedby="id_reimbursement" name="id_reimbursement"
                                        style="color: #1f1f1f; width: 300px;"
                                        value="{{ $reimbursement->nama_karyawan }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control-plaintext mb-1"
                                        aria-describedby="id_supplier" name="id_supplier"
                                        style="color: #1f1f1f; width: 300px;" value="{{ $lamp1->nama_supplier ?? '-' }}"
                                        readonly>
                                </div>
                            </div>
                            {{-- <div class="form-group mb-1 row">
                                <label class="col-sm-3 col-form-label" style="color: black; width: 25%;">Nama
                                    Proyek</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control-plaintext mb-1" aria-describedby="id_proyek"
                                        name="id_proyek" style="color: #1f1f1f; width: 300px;"
                            ...
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9 text-justify">
                                    <textarea class="form-control-plaintext mb-1" aria-describedby="id_reimbursement" name="id_reimbursement"
                                        style="color: #1f1f1f; width: 300px;" readonly>{{ $reimbursement->keterangan }}</textarea>
                                </div>
                            </div>
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control-plaintext mb-1"
                                        aria-describedby="id_reimbursement" name="id_reimbursement"
                                        style="color: #1f1f1f; width: 300px;"
                                        value="{{ !is_null($reimbursement->nama_status_pengajuan_ky) ? $reimbursement->nama_status_pengajuan_ky : (!is_null($reimbursement->nama_status_pengajuan_mk) ? $reimbursement->nama_status_pengajuan_mk : $reimbursement->nama_status_pengajuan) }}"
                                        readonly>
                                </div>
                            </div>
                            @if (
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="form-group mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" class="form-control-plaintext mb-1"
                                            ...
                                            style="color: #1f1f1f; width: 300px;" value="{{ $namaKaryawan }}"
                                            readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control-plaintext mb-1"
                                            aria-describedby="alasan_revisi_kd" name="alasan_revisi_kd"
                                            style="color: #1f1f1f; width: 300px;"
                                            value="{{ $reimbursement->alasan_revisi_kd ?: '-' }}" readonly>
                                    </div>
                                ...
                                <div class="form-group mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control-plaintext mb-1"
                                            aria-describedby="alasan_ditolak_kd " name="alasan_ditolak_kd"
                                            style="color: #1f1f1f; width: 300px;"
                                            value="{{ $reimbursement->alasan_ditolak_kd ?: '-' }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        @php
                                            $tanggalVerifikasiKD = !empty($reimbursement->tanggal_verifikasi_kd) ? date('d-m-Y H:i:s', strtotime($reimbursement->tanggal_verifikasi_kd)) : '-';
                                        @endphp
                                        <input type="text" class="form-control-plaintext mb-1"
                                ...
                                <div class="form-group mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" class="form-control-plaintext mb-1"
                                            ...
                                            style="color: #1f1f1f; width: 300px;" value="{{ $namaKaryawanMK }}"
                                            readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control-plaintext mb-1"
                                            ...
                                            name="nama_status_pengajuan_mk" style="color: #1f1f1f; width: 300px;"
