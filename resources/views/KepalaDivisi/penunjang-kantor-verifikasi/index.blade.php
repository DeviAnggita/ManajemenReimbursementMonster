            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    {{-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/kepala-divisi/penunjang-kantor-export-excel"
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('penunjang-kantor-verifikasi-kd.index') }}"
                                        class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/kepala-divisi/penunjang-kantor-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTablePenunjangKantorKD" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            ...
                                            --}}
                                                <td class="d-flex">
                                                    ...
                                                    @include('KepalaDivisi.penunjang-kantor-verifikasi.showVerifikasi')
                                                    ...
                                                    @if ($reimbursement->id_status_pengajuan_mk === null || $reimbursement->id_status_pengajuan_mk == 41)
                                                        ...
                                                        @include('KepalaDivisi.penunjang-kantor-verifikasi.update')
                                                    @endif
                                                    {{-- SHOW Reimbursement Medical --}}
                                                    <a href="{{ route('penunjang-kantor-verifikasi-kd.show', $reimbursement->id_reimbursement) }}"
