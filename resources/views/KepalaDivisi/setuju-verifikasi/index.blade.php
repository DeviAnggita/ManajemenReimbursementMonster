...
<head>
    ...
    <title>Data Verifikasi Setuju Reimbursement</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    {{-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/kepala-divisi/setuju-verifikasi-export-excel"
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            <div class="row mb-3">
                                <div class="col">
                                    <h2 class="h5 mb-0 text-gray-800">Verifikasi Setuju Reimbursement -
                                        {{ $tahun_terpilih }}
                                    </h2>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('setuju-verifikasi-kd.index') }}"
                                        class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/kepala-divisi/setuju-verifikasi-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Data Tabel Verifikasi Setuju Reimbursement
                            </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTableSetujuKD" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    @include('KepalaDivisi.setuju-verifikasi.showVerifikasi')
                                                    ...
                                                    @if (in_array($reimbursement->id_status_pengajuan, $allowedStatus->pluck('id_status_pengajuan')->toArray()))
                                                        ...
                                                        <!-- MODAL UPDATE SETUJU -->
                                                        @include('KepalaDivisi.setuju-verifikasi.update')
                                                    @endif
                                                    {{-- SHOW Reimbursement Medical --}}
                                                    <a href="{{ route('setuju-verifikasi-kd.show', $reimbursement->id_reimbursement) }}"
