...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        @include('template.left-sidebar-KepalaDivisi')
        <!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                @include('template.navbar-KepalaDivisi')
                <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    {{-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/kepala-divisi/export-excel"
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <form method="GET" action="{{ route('kepaladivisi.dashboard') }}" class="ml-3">
                        ...
                        <div>
                            <a href="/kepala-divisi/export-excel?tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="/kepala-divisi/medical-verifikasi" style="text-decoration: none;">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="/kepala-divisi/perjalanan-bisnis-verifikasi" style="text-decoration: none;">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="/kepala-divisi/penunjang-kantor-verifikasi" style="text-decoration: none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-gray-800">Kepala Divisi</h6>
                                </div>
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">Menunggu
                                        <span class="float-right"><?= $percentageMenungguKD ?>%</span>
                                    </h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-warning" role="progressbar"
                                            style="width: <?= $percentageMenungguKD ?>%"
                                            aria-valuenow="<?= $percentageMenungguKD ?>" aria-valuemin="0"
                                            aria-valuemax="100">
                                        </div>
                                    </div>
                                    <h4 class="small font-weight-bold">Setuju
                                        <span class="float-right"><?= $percentageSetujuKD ?>%</span>
                                    </h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-success" role="progressbar"
                                            style="width: <?= $percentageSetujuKD ?>%"
                                            aria-valuenow="<?= $percentageSetujuKD ?>" aria-valuemin="0"
                                            aria-valuemax="100">
                                        </div>
                                    </div>
                                    <h4 class="small font-weight-bold">Revisi
                                        <span class="float-right"><?= $percentageRevisiKD ?>%</span>
                                    </h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-info" role="progressbar"
                                            style="width: <?= $percentageRevisiKD ?>%"
                                            aria-valuenow="<?= $percentageRevisiKD ?>" aria-valuemin="0"
                                            aria-valuemax="100">
                                        </div>
                                    </div>
                                    <h4 class="small font-weight-bold">Tolak
                                        <span class="float-right"><?= $percentageTolakKD ?>%</span>
                                    </h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-danger" role="progressbar"
                                            style="width: <?= $percentageTolakKD ?>%"
                                            aria-valuenow="<?= $percentageTolakKD ?>" aria-valuemin="0"
                                            aria-valuemax="100">
                                        </div>
                                    </div>
                        ...
                        {{-- <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">Menunggu
                                        <span class="float-right"><?= $percentageMenungguMK ?>%</span>
                                    </h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-warning" role="progressbar"
                                            style="width: <?= $percentageMenungguMK ?>%"
                                            aria-valuenow="<?= $percentageMenungguMK ?>" aria-valuemin="0"
                                            aria-valuemax="100">
                                        </div>
                                    </div>
                                    <h4 class="small font-weight-bold">Setuju
                                        <span class="float-right"><?= $percentageSetujuMK ?>%</span>
                                    </h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-success" role="progressbar"
                                            style="width: <?= $percentageSetujuMK ?>%"
                                            aria-valuenow="<?= $percentageSetujuMK ?>" aria-valuemin="0"
                                            aria-valuemax="100">
                                        </div>
                                    </div>
                                    <h4 class="small font-weight-bold">Revisi
                                        <span class="float-right"><?= $percentageRevisiMK ?>%</span>
                                    </h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-info" role="progressbar"
                                            style="width: <?= $percentageRevisiMK ?>%"
                                            aria-valuenow="<?= $percentageRevisiMK ?>" aria-valuemin="0"
                                            aria-valuemax="100">
                                        </div>
                                    </div>
                                    <h4 class="small font-weight-bold">Tolak
                                        <span class="float-right"><?= $percentageTolakMK ?>%</span>
                                    </h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-danger" role="progressbar"
                                            style="width: <?= $percentageTolakMK ?>%"
                                            aria-valuenow="<?= $percentageTolakMK ?>" aria-valuemin="0"
                                            aria-valuemax="100">
                                        </div>
                                    </div>
                                    <h4 class="small font-weight-bold">Selesai<span
                                            class="float-right"><?= $percentageSelesaiMK ?>%</span>
                                    </h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar" role="progressbar"
                                            style="width: <?= $percentageSelesaiMK ?>%"
                                            aria-valuenow="<?= $percentageSelesaiMK ?>" aria-valuemin="0"
...
<script>
    ...
    //                 hoverBackgroundColor: "#2e59d9",
    //                 borderColor: "#4e73df",
    //                 data: [<?= $totalReimbursementJanMedical ?>,
