...
<head>
    ...
    <title>Data Verifikasi Reimbursement Perjalanan Bisnis</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    {{-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/kepala-divisi/perjalanan-bisnis-export-excel"
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            <div class="row mb-3">
                                <div class="col">
                                    <h2 class="h5 mb-0 text-gray-800">Reimbursement Perjalanan Bisnis -
                                        {{ $tahun_terpilih }}
                                    </h2>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('perjalanan-bisnis-verifikasi-kd.index') }}"
                                        class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/kepala-divisi/perjalanan-bisnis-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTablePerjalananBisnisKD" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            <tr>
                                                ...
                                                <td>{{ $lampirans->where('id_reimbursement', $reimbursement->id_reimbursement)->first()->nama_proyek }}
                                                </td>
                                                ...
                                                <td>
                                                    @php
                                                        if ($reimbursement->id_status_pengajuan == 10 && $reimbursement->id_status_pengajuan_mk == 41) {
                                                            $nama_status_pengajuan = $reimbursement->nama_status_pengajuan;
                                                        } elseif ($reimbursement->id_status_pengajuan == 28 || $reimbursement->id_status_pengajuan == 34 || $reimbursement->id_status_pengajuan == 11) {
                                                            $nama_status_pengajuan = $reimbursement->nama_status_pengajuan;
                                                        } elseif (!is_null($reimbursement->nama_status_pengajuan_ky)) {
                                            ...
                                            --}}
                                                <td class="d-flex">
                                                    ...
                                                    @include('KepalaDivisi.perjalanan-bisnis-verifikasi.showVerifikasi')

                                                    <!-- UPDATE PERJALANAN BISNIS -->
                                                    @if ($reimbursement->id_status_pengajuan_mk === null || $reimbursement->id_status_pengajuan_mk == 41)
                                                        <button type="button" class="btn btn-warning btn-circle btn-sm"
                                                            data-toggle="modal"
                                                            data-target="#editModalVerifReimbursement{{ $reimbursement->id_reimbursement }}">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                        <!-- MODAL UPDATE Perjalanan Bisnis -->
                                                        @include('KepalaDivisi.perjalanan-bisnis-verifikasi.update')
                                                    @endif
                                                    {{-- SHOW Reimbursement Medical --}}
                                                    <a href="{{ route('perjalanan-bisnis-verifikasi-kd.show', $reimbursement->id_reimbursement) }}"
