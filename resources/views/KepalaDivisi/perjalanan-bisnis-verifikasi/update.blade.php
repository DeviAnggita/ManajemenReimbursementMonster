    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST"
                    action="{{ route('perjalanan-bisnis-verifikasi-kd.update', $reimbursement->id_reimbursement) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-3" id="form-alasan-revisi">
                        ...
                        {{-- <div class="col-sm-9"> --}}
                        <textarea class="form-control" id="alasan_revisi_kd" name="alasan_revisi_kd" rows="3">{{ $reimbursement->alasan_revisi_kd }}</textarea>
                    ...
                    <div class="form-group mb-3" id="form-alasan-ditolak">
                        ...
                        {{-- <div class="col-sm-9"> --}}
                        <textarea class="form-control" id="alasan_ditolak_kd" name="alasan_ditolak_kd" rows="3">{{ $reimbursement->alasan_ditolak_kd }}</textarea>
