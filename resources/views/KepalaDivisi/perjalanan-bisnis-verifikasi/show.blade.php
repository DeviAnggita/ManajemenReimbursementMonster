...
<head>
    ...
    <title>Detail Verifikasi Reimbursement Perjalanan Bisnis </title>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="font-weight-bold text-gray-900">
                                <a href="/kepala-divisi/perjalanan-bisnis-verifikasi" class="arrow-link">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control-plaintext mb-1"
                                        aria-describedby="id_proyek" name="id_proyek"
                                        style="color: #1f1f1f; width: 300px;" value="{{ $lamp2->nama_proyek ?? '-' }}"
                                        readonly>
                                </div>
                            </div>
                            <div class=" form-group mb-1 row">
