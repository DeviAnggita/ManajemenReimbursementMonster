...
<head>
    ...
    <title>Data Verifikasi Revisi Reimbursement</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    {{-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/kepala-divisi/revisi-verifikasi-export-excel"
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            <div class="row mb-3">
                                <div class="col">
                                    <h2 class="h5 mb-0 text-gray-800">Verifikasi Revisi Reimbursement -
                                        {{ $tahun_terpilih }}
                                    </h2>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('revisi-verifikasi-kd.index') }}"
                                        class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/kepala-divisi/revisi-verifikasi-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Data Tabel Verifikasi Revisi Reimbursement
                            </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTableRevisiKD" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                                ...
                                                <td>
                                                    @php
                                                        ...
                                                        switch ($nama_status_pengajuan) {
                                                            ...
                                                            case 'Menunggu Persetujuan Manager Keuangan':
                                            ...
                                            --}}
                                                <td class="d-flex">
                                                    ...
                                                    @include('KepalaDivisi.revisi-verifikasi.showVerifikasi')
                                                    ...
                                                    @if (in_array($reimbursement->id_status_pengajuan, $allowedStatus->pluck('id_status_pengajuan')->toArray()))
                                                        ...
                                                        <!-- MODAL UPDATE Revisi -->
                                                        @include('KepalaDivisi.revisi-verifikasi.update')
                                                    @endif

                                                    {{-- SHOW Reimbursement Medical --}}
                                                    <a href="{{ route('revisi-verifikasi-kd.show', $reimbursement->id_reimbursement) }}"
