...
<head>
    ...
    <title>Detail Verifikasi Reimbursement</title>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="font-weight-bold text-gray-900">
                                <a href="/kepala-divisi/verifikasi" class="arrow-link">
                                ...
                                <div class="form-group mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control-plaintext mb-1"
                                            ...
                                            style="color: #1f1f1f; width: 300px;"
                                            value="@if (!empty($userVerifikasiKD->nama_karyawan)) {{ $userVerifikasiKD->nama_karyawan }} @else Belum ada @endif"
                                            readonly>
                                    </div>
                                </div>
