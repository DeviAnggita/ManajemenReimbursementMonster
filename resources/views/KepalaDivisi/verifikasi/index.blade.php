                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('verifikasi-kd.index') }}" class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/kepala-divisi/verifikasi-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTableVerifikasiKD" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    @include('KepalaDivisi.verifikasi.showVerifikasi')
                                                    ...
                                                    @if (in_array($reimbursement->id_status_pengajuan, $allowedStatus->pluck('id_status_pengajuan')->toArray()))
                                                        ...
                                                        @include('KepalaDivisi.verifikasi.update')
                                                    @endif

                                                    <a href="{{ route('verifikasi-kd.show', $reimbursement->id_reimbursement) }}"
