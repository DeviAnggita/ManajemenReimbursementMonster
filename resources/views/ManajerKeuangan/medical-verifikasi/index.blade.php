...
<head>
    ...
    <title>Data Verifikasi Medical Reimbursement</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    {{-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/manajer-keuangan/medical-export-excel"
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            <div class="row mb-3">
                                <div class="col">
                                    <h2 class="h5 mb-0 text-gray-800">Reimbursement Medical - {{ $tahun_terpilih }}
                                    </h2>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('medical-verifikasi-mk.index') }}"
                                        class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/manajer-keuangan/medical-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Data Tabel Verifikasi Medical Reimbursement
                            </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTableMedicalMK" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            ...
                                            --}}
                                                <td class="d-flex">
                                                    ...
                                                    @include('ManajerKeuangan.medical-verifikasi.showVerifikasi')
                                                    ...
                                                    @if (!in_array($reimbursement->id_status_pengajuan_sk, [45]))
                                                        ...
                                                        {{-- MODAL UPDATE DIVISI --}}
                                                        @include('ManajerKeuangan.medical-verifikasi.update')
                                                    @endif


                                                    {{-- SHOW Reimbursement Medical --}}
                                                    <a href="{{ route('medical-verifikasi-mk.show', $reimbursement->id_reimbursement) }}"
