...
<head>
    ...
    <title>Data Verifikasi Selesai Reimbursement</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    {{-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h6 mb-0 text-gray-1000">Dashboard</h2>
                        <a href="/manajer-keuangan/selesai-verifikasi-export-excel"
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            <div class="row mb-3">
                                <div class="col">
                                    <h2 class="h5 mb-0 text-gray-800">Selesai Reimbursement - {{ $tahun_terpilih }}
                                    </h2>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('selesai-reimbursement-mk.index') }}"
                                        class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/manajer-keuangan/selesai-reimbursement-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Data Table Selesai Reimbursement
                            </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTableSelesaiMK" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {{-- MODAL UPDATE DIVISI --}}
                                                    {{-- @include('ManajerKeuangan.selesai-reimbursement.update') --}}
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    @include('ManajerKeuangan.selesai-reimbursement.showVerifikasi')


                                                    {{-- SHOW Reimbursement Medical --}}
                                                    <a href="{{ route('selesai-reimbursement-mk.show', $reimbursement->id_reimbursement) }}"
