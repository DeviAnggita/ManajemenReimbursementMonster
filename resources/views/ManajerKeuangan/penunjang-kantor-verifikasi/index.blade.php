                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('penunjang-kantor-verifikasi-mk.index') }}"
                                        class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/manajer-keuangan/penunjang-kantor-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            ...
                                            --}}
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    @include('ManajerKeuangan.penunjang-kantor-verifikasi.showVerifikasi')
                                                    ...
                                                    @if (!in_array($reimbursement->id_status_pengajuan_sk, [45]))
                                                        ...
                                                        {{-- MODAL UPDATE DIVISI --}}
                                                        @include('ManajerKeuangan.penunjang-kantor-verifikasi.update')
                                                    @endif


                                                    {{-- SHOW Reimbursement Medical --}}
                                                    <a href="{{ route('penunjang-kantor-verifikasi-mk.show', $reimbursement->id_reimbursement) }}"
