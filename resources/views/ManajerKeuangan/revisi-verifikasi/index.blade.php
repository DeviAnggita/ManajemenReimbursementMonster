            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    {{-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/manajer-keuangan/revisi-verifikasi-export-excel"
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('revisi-verifikasi-mk.index') }}"
                                        class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/manajer-keuangan/revisi-verifikasi-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Data Tabel Revisi Verifikasi Reimbursement
                            </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTableRevisiMK" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    @include('ManajerKeuangan.revisi-verifikasi.showVerifikasi')
                                                    ...
                                                    @if (!in_array($reimbursement->id_status_pengajuan_ky, [17, 6, 5]))
                                                        ...
                                                        {{-- MODAL UPDATE DIVISI --}}
                                                        @include('ManajerKeuangan.revisi-verifikasi.update')
                                                    @endif


                                                    {{-- SHOW Reimbursement Medical --}}
                                                    <a href="{{ route('revisi-verifikasi-mk.show', $reimbursement->id_reimbursement) }}"
