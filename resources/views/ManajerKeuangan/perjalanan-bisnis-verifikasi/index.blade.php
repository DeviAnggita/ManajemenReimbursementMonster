            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    {{-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/manajer-keuangan/perjalanan-bisnis-export-excel"
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('perjalanan-bisnis-verifikasi-mk.index') }}"
                                        class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/manajer-keuangan/perjalanan-bisnis-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTablePerjalananBisnisMK" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        if ($reimbursement->id_status_pengajuan_mk == 8 && $reimbursement->id_status_pengajuan_sk == 46) {
                                                            $nama_status_pengajuan = $reimbursement->nama_status_pengajuan_mk;
                                                        } elseif ($reimbursement->id_status_pengajuan_mk == 41 || $reimbursement->id_status_pengajuan_mk == 35 || $reimbursement->id_status_pengajuan_mk == 9) {
                                                            $nama_status_pengajuan = $reimbursement->nama_status_pengajuan_mk;
                                                        ...
                                                        } elseif (!is_null($reimbursement->nama_status_pengajuan)) {
                                            ...
                                            --}}
                                                <td class="d-flex">
                                                    ...
                                                    @include('ManajerKeuangan.perjalanan-bisnis-verifikasi.showVerifikasi')

                                                    <!-- UPDATE DIVISI -->
                                                    @if (!in_array($reimbursement->id_status_pengajuan_sk, [45]))
                                                        <button type="button" class="btn btn-warning btn-circle btn-sm"
                                                            data-toggle="modal"
                                                            data-target="#editModalVerifReimbursement{{ $reimbursement->id_reimbursement }}">
                                                            <i class="fas fa-edit"></i></button>
                                                        {{-- MODAL UPDATE DIVISI --}}
                                                        @include('ManajerKeuangan.perjalanan-bisnis-verifikasi.update')
                                                    @endif


                                                    {{-- SHOW Reimbursement Medical --}}
                                                    <a href="{{ route('perjalanan-bisnis-verifikasi-mk.show', $reimbursement->id_reimbursement) }}"
