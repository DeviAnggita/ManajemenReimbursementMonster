                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="font-weight-bold text-gray-900">
                                <a href="/manajer-keuangan/verifikasi" class="arrow-link">
                                    ...
                                    <div class="form-group mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control-plaintext mb-1"
                                                ...
                                                style="color: #1f1f1f; " value="{{ $lampiran->nomor_kwitansi }}"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="form-group mb-1 row">
                                    ...
                                    <div class="form-group mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control-plaintext mb-1"
                                                ...
                                                style="color: #1f1f1f;" value="{{ $lampiran->judul_kwitansi }}"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="form-group mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control-plaintext mb-1"
                                                ...
                                                style="color: #1f1f1f; " value="{{ $lampiran->nama_kwitansi }}"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control-plaintext mb-1"
                                                ...
                                                style="color: #1f1f1f; " value="{{ $lampiran->keterangan }}"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="form-group mb-1 row">
