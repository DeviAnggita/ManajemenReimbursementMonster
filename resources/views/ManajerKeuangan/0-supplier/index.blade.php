...
<head>
    ...
    <title>Manajer Keuangan - Data Supplier</title>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                @include('ManajerKeuangan.supplier.create')
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                ...
                                                {{-- MODAL SHOW SUPPLIER --}}
                                                @include('ManajerKeuangan.supplier.show')
                                                ...
                                                @include('ManajerKeuangan.supplier.update')
                                                ...
                                                @include('ManajerKeuangan.supplier.delete')
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
