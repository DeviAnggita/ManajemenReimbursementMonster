                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <form method="GET" action="{{ route('manajerkeuangan.dashboard') }}" class="ml-3">
                        ...
                        <div>
                            <a href="/manajer-keuangan/export-excel?tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="/manajer-keuangan/medical-verifikasi" style="text-decoration: none;">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="/manajer-keuangan/perjalanan-bisnis-verifikasi" style="text-decoration: none;">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="/manajer-keuangan/penunjang-kantor-verifikasi" style="text-decoration: none;">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="small font-weight-bold">Selesai
                                        <span class="float-right"> <?= $percentageSelesaiMK ?>%</span>
                                    </h4>
                                    <div class="progress mb-4">
