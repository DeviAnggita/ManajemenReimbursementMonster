                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/staff-keuangan/medical-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            ...
                                            --}}
                                                <td class="d-flex">
                                                    ...
                                                    @include('StaffKeuangan.medical-verifikasi.showVerifikasi')
                                                    ...
                                                    @if (!in_array($reimbursement->id_status_pengajuan_ky, [17, 6, 5]))
                                                        ...
                                                        {{-- MODAL UPDATE DIVISI --}}
                                                        @include('StaffKeuangan.medical-verifikasi.update')
                                                    @endif

                                                    {{-- SHOW Reimbursement Medical --}}
                                                    <a href="{{ route('medical-verifikasi-sk.show', $reimbursement->id_reimbursement) }}"
