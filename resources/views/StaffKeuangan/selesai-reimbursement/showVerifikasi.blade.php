<div class="modal fade" id="showReimbursementModal-{{ $reimbursement->id_reimbursement }}" tabindex="-1" role="dialog"
    ...
    aria-hidden="true">
    {{-- <form action="{{ route('setuju-verifikasi-mk.update', $reimbursement->id_reimbursement) }}" method="POST"> --}}
                    ...
                    <div class="card-body">
                        ...
                        @if ($reimbursement->id_status_pengajuan == 34)
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control-plaintext mb-1" row="5" aria-describedby="alasan_revisi_kd" name="alasan_revisi_kd"
                        ...
                        @if ($reimbursement->id_status_pengajuan == 11)
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control-plaintext mb-1" row="5" aria-describedby="alasan_ditolak_kd "
                                        name="alasan_ditolak_kd" style="color: #1f1f1f; width: 300px;" readonly>{{ $reimbursement->alasan_ditolak_kd ?: '-' }}</textarea>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="form-group mb-1 row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" class="form-control-plaintext mb-1"
                                    ...
                                    style="color: #1f1f1f; width: 300px;" value="{{ $tanggalVerifikasiKD }}" readonly>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        @if ($reimbursement->id_status_pengajuan_mk == 35)
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control-plaintext mb-1" row="5" aria-describedby="alasan_revisi_mk"
                                        name="alasan_revisi_mk" style="color: #1f1f1f; width: 300px;" readonly>{{ $reimbursement->alasan_revisi_mk ?: '-' }}</textarea>
                                </div>
                            </div>
                        @endif
                        ...
                        @if ($reimbursement->id_status_pengajuan_mk == 9)
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control-plaintext mb-1" row="5" aria-describedby="alasan_ditolak_mk "
                                        name="alasan_ditolak_mk" style="color: #1f1f1f; width: 300px;" readonly>{{ $reimbursement->alasan_ditolak_mk ?: '-' }}</textarea>
                                </div>
                            </div>
                        @endif
