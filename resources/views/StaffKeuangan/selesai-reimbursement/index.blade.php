                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('selesai-reimbursement-sk.index') }}"
                                        class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/staff-keuangan/selesai-reimbursement-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    @include('StaffKeuangan.selesai-reimbursement.showVerifikasi')


                                                    {{-- SHOW Reimbursement Medical --}}
                                                    <a href="{{ route('selesai-reimbursement-sk.show', $reimbursement->id_reimbursement) }}"
