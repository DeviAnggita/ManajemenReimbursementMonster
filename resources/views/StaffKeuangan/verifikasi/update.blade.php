    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('verifikasi-sk.update', $reimbursement->id_reimbursement) }}"
...
<script>
    ...
    errorMessage.innerHTML =
        'Inputan tidak boleh melebihi total reimbursement "{{ number_format($reimbursement->total_setuju_mk, 0, ',', '.') }}"!';
