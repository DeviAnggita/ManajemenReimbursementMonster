...
<head>
    ...
    <title>Data Verifikasi Reimbursement</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    {{-- <h1 class="h3 mb-2 text-gray-800">Verifikasi Reimbursement Kepala Divisi</h1> --}}
                    {{-- <p class="mb-4">Data master reimbursement medical berisikan data reimbursement medical</p> --}}

                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            <div class="row mb-3">
                                <div class="col">
                                    <h2 class="h5 mb-0 text-gray-800">Verifikasi Reimbursement - {{ $tahun_terpilih }}
                                    </h2>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('verifikasi-sk.index') }}" class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/staff-keuangan/verifikasi-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Data Tabel Verifikasi Reimbursement</h6>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTableVerifikasiMK" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $nama_status_pengajuan = !is_null($reimbursement->nama_status_pengajuan_sk) ? $reimbursement->nama_status_pengajuan_sk : (!is_null($reimbursement->nama_status_pengajuan_mk) ? $reimbursement->nama_status_pengajuan_mk : $reimbursement->nama_status_pengajuan);
                                                        $btnClass = '';
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    @include('StaffKeuangan.verifikasi.showVerifikasi')
                                                    ...
                                                    {{-- MODAL UPDATE DIVISI --}}
                                                    @include('StaffKeuangan.verifikasi.update')


                                                    {{-- SHOW Reimbursement Medical --}}
                                                    <a href="{{ route('verifikasi-sk.show', $reimbursement->id_reimbursement) }}"
