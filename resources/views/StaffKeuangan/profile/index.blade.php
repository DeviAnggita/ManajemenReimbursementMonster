                        ...
                        <div class="col-md-3">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form
                                        action="{{ route('sk.profile.updateFotoProfile', ['id_user' => $karyawan->id_user]) }}"
                        ...
                        <div class="col-md-5">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form
                                        action="{{ route('sk.profile.updateKelolaPengguna', ['id_user' => $karyawan->id_user]) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="id_user" id="id_user">
                        ...
                        <div class="col-md-4">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Add Reimbursement Form -->
                                    <form
                                        action="{{ route('sk.profile.updateKelolaAkun', ['id_user' => $karyawan->id_user]) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="id_user" id="id_user">
