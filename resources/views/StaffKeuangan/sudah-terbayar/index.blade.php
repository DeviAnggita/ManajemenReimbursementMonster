...
<head>
    ...
    <title>Data Verifikasi Sudah Terbayar Reimbursement</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            <div class="row mb-3">
                                <div class="col">
                                    <h2 class="h5 mb-0 text-gray-800">Verifikasi Sudah Terbayar Reimbursement -
                                        {{ $tahun_terpilih }}
                                    </h2>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('sudah-terbayar-sk.index') }}" class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/staff-keuangan/sudah-terbayar-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            ...
                                            --}}
                                                <td class="d-flex">
                                                    ...
                                                    @include('StaffKeuangan.sudah-terbayar.showVerifikasi')
                                                    ...
                                                    @if (!in_array($reimbursement->id_status_pengajuan_ky, [17, 6, 5]))
                                                        ...
                                                        {{-- MODAL UPDATE DIVISI --}}
                                                        @include('StaffKeuangan.sudah-terbayar.update')
                                                    @endif

                                                    {{-- SHOW Reimbursement Medical --}}
                                                    <a href="{{ route('sudah-terbayar-sk.show', $reimbursement->id_reimbursement) }}"
