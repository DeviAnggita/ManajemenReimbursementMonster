                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-2">
                        <div class="col">
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('medical.index') }}" class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/superadmin/medical-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Laporan Reimbursement Medical</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">

                                <!-- Add the search form -->
                                {{-- <form action="{{ route('medical.index') }}" method="GET">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTableMedicalSA" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                        ...
                                        @foreach ($reimbursements as $reimbursement)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    <a href="{{ route('medical.show', $reimbursement->id_reimbursement) }}"
                                                    ...
                                                    {{-- MODAL SHOW PEGAWAI --}}
                                                    @include('SuperAdmin.medical.showVerifikasi')
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-toggle="modal"
                                                        data-target="#deleteModalMedical{{ $reimbursement->id_reimbursement }}"
                                                        title="Delete Reimbursement"><i
                                                            class="fas fa-trash"></i></button>
                                                    {{-- MODAL DELETE Supplier --}}
                                                    @include('SuperAdmin.medical.delete')
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
