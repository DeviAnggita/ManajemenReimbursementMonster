                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('medical.update', $reimbursement->id_reimbursement) }}"
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <select class="form-control" onchange="showhidesupplierproyekUpdate(this);"
                                        ...
                                        <div class="col-sm-12">
                                            <label class="form-control mb-2 row">
                                                <input type="radio" name="id_jenis_reimbursement"
                                                    ...
                                                    onchange="showhidesupplierproyekUpdate(this);">
                                                {{ $jenis->nama_jenis_reimbursement }}
                                            </label>
                                        </div>
                                    @endforeach
                                ...
                                <script>
                                    ...
                                    function showhidesupplierproyekUpdate(select) {
                                    ...
                                    showhidesupplierproyekUpdate(document.querySelector("[name='id_jenis_reimbursement']"));
                                </script>
                                        ...
                                        function deleteLampiran(lampiranId, ajaxIndex) {
                                            ...
                                            xhr.onload = function() {
                                                if (xhr.status === 200) {
                                                    ...
                                                    // Panggil fungsi updateTotalCreate untuk memperbarui total
                                                    updateTotalCreate();
