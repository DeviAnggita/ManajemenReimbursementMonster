        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tabel Data Proyek</h1>
                    <p class="mb-4">Data master proyek berisikan data proyek</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Data Tabel Proyek</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <button href="#"
                                    ...
                                    data-toggle="modal" data-target="#tambahDataProyekModal" type="button">
                                    <i class="fa fa-plus"></i>
                                    Tambah Data Proyek
                                </button>

                                <!--Modal Tambah Data Supplier  -->
                                @include('SuperAdmin.proyek.create')
                                ...
                                <table class="table table-bordered" id="dataTableProyek" width="100%" cellspacing="0">
                                    ...
                                    <tbody id="tableBodyContainer">
                                        ...
                                        @foreach ($proyeks as $proyek)
                                            <tr>
                                                <td>{{ $no++ }}</td>
                                                <td>{{ $proyek->nomor_proyek }}</td>
                                                <td>{{ $proyek->nama_proyek }}</td>
                                                <td>
                                                    @if ($proyek->status_active == 1)
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    data-toggle="modal"
                                                    data-target="#showProyekModal-{{ $proyek->id_proyek }}">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                MODAL SHOW SUPPLIER
                                                @include('SuperAdmin.proyek.show') --}}

                                                    <!-- UPDATE SUPPLIER  -->
                                                    <button type="button" class="btn btn-warning btn-circle btn-sm"
                                                        data-toggle="modal"
                                                        data-target="#editModalProyek{{ $proyek->id_proyek }}"> <i
                                                            class="fas fa-edit"></i></button>
                                                    {{-- MODAL UPDATE SUPPLIER --}}
                                                    @include('SuperAdmin.proyek.update')

                                                    {{-- DELETE SUPPLIER --}}
                                                    <button type="button"
                                                        class="btn btn-danger btn-circle btn-sm flex-end"
                                                        data-toggle="modal"
                                                        data-target="#deleteModalProyek{{ $proyek->id_proyek }}"><i
                                                            class="fas fa-trash"></i></button>
                                                    {{-- MODAL DELETE Supplier --}}
                                                    @include('SuperAdmin.proyek.delete')
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
