                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('reimbursement.store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="id_user" id="nama_karyawan" class="form-control"
                                            ...
                                            @foreach ($user as $u)
                                                <option value="{{ $u->id_user }}">{{ $u->nama_karyawan }} -
                                                    {{ $u->nama_divisi }} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('id_user')
                                ...
                                {{-- <div class="form-group">
                                    <label for="total">Total</label>
                                    <input type="text" name="total" id="total_create" class="form-control"
                                        value="{{ old('total') }}" onkeyup="formatRupiah(this)"
                                        onchange="updateTotalCreate()" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="total_hidden" id="total_hidden"
                                        value="{{ old('total') }}">
                                    <span class="text-muted">*Total will be automatically filled when the total kwitansi
                                        in the attachments is filled.</span>
                                    @error('total')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div> --}}
