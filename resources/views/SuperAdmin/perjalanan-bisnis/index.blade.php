...
<head>
    ...
    <title>Data Reimbursement Perjalanan Bisnis</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-2">
                        <div class="col">
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('perjalanan-bisnis.index') }}" class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/superadmin/perjalanan-bisnis-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Laporan Reimbursement Perjalanan Bisnis</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">

                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTablePerjalananBisnisSA" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($lampiran->status_active == 1)
                                                        <span class="text-primary">{{ $lampiran->nama_proyek }}</span>
                                                    @else
                                                        <span class="text-danger">{{ $lampiran->nama_proyek }}</span>
                                                    @endif
                                                </td>
                                                ...
                                                <td class="d-flex">
                                                    {{-- SHOW ReimbursementPERJALANAN BISNIS --}}
                                                    <a href="{{ route('perjalanan-bisnis.show', $reimbursement->id_reimbursement) }}"
                                                        class="btn btn-info btn-circle btn-sm"
                                                        title="Show Reimbursement">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    {{-- SHOW PERJALANAN BISNIS  --}}
                                                    <button type="button" class="btn btn-primary btn-circle btn-sm"
                                                        data-toggle="modal"
                                                        data-target="#showReimbursementModal-{{ $reimbursement->id_reimbursement }}">
                                                        <i class="fas fa-history text-black"></i>
                                                    </button>
                                                    {{-- MODAL SHOW PERJALANAN BISNIS --}}
                                                    @include('SuperAdmin.perjalanan-bisnis.showVerifikasi')

                                                    <!-- UPDATE Reimbursement Medical  -->
                                                    @if (in_array($reimbursement->id_user, $allowedUpdate))
                                                        <a href="{{ route('perjalanan-bisnis.edit', $reimbursement->id_reimbursement) }}"
                                                            class="btn btn-warning btn-circle btn-sm"
                                                            title="Update Reimbursement">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                    @endif
                                                    {{-- DELETE Reimbursement PERJALANAN BISNIS --}}
                                                    <button type="button"
                                                        class="btn btn-danger btn-circle btn-sm flex-end"
                                                        data-toggle="modal" title="Delete Reimbursement"
                                                        data-target="#deleteModalPerjalananBisnis{{ $reimbursement->id_reimbursement }}"><i
                                                            class="fas fa-trash"></i></button>
                                                    {{-- MODAL DELETE Supplier --}}
                                                    @include('SuperAdmin.perjalanan-bisnis.delete')
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
