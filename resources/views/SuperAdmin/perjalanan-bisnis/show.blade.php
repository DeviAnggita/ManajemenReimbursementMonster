...
<head>
    ...
    <title>Detail Reimbursement Perjalanan Bisnis</title>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="font-weight-bold text-gray-900">
                                <a href="/superadmin/perjalanan-bisnis" class="arrow-link">
                                    <i class="fa fa-arrow-left" aria-hidden="true"></i>
                                </a>
                                Detail Reimbursement Perjalanan Bisnis
                            </h6>
                        </div>
                        ...
                        <div class="card-body mb-1">
                            ...
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control-plaintext mb-1"
                                        aria-describedby="tanggal_bayar" name="tanggal_bayar"
                                        style="color: #1f1f1f; width: 300px;"
                                        value="{{ \Carbon\Carbon::parse($reimbursement->tanggal_bayar)->format('d-m-Y') }}"readonly>
                                </div>
                            </div>
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control-plaintext mb-1"
                                        aria-describedby="tanggal_reimbursement" name="tanggal_reimbursement"
                                        style="color: #1f1f1f; width: 300px;"
