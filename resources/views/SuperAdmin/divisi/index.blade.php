        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tabel Data Master Divisi</h1>
                    <p class="mb-4">Data master divisi berisikan data divisi</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Data Tabel Divisi</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <button href="#"
                                    ...
                                    data-toggle="modal" data-target="#tambahDataDivisiModal" type="button">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTableDivisi" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Nama Divisi</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    <button type="button" class="btn btn-warning btn-circle btn-sm"
                                                        data-toggle="modal"
                                                        data-target="#editModalDivisi{{ $divisi->id_divisi }}">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    {{-- MODAL UPDATE DIVISI --}}
                                                    @include('SuperAdmin.divisi.update')

                                                    {{-- DELETE DIVISI --}}
                                                    <button type="button"
                                                        class="btn btn-danger btn-circle btn-sm flex-end"
                                                        data-toggle="modal"
                                                        data-target="#deleteModalDivisi{{ $divisi->id_divisi }}">
                                                        <i class="fas fa-trash"></i>
                                                    </button>
                                                    {{-- MODAL DELETE DIVISI --}}
                                                    @include('SuperAdmin.divisi.delete')
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
