        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Table Data Master Lampiran</h1>
                    <p class="mb-4">Data master lampiran berisikan data lampiran</p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                @include('SuperAdmin.lampiran.create')
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                ...
                                                {{-- MODAL SHOW SUPPLIER --}}
                                                @include('SuperAdmin.lampiran.show')
                                                ...
                                                @include('SuperAdmin.lampiran.update')
                                                ...
                                                @include('SuperAdmin.lampiran.delete')
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
