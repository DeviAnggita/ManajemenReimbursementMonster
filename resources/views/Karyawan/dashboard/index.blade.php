            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    {{-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/karyawan/export-excel"
                            class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i>Download Laporan Excel
                        </a>
                    </div> --}}
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="d-flex align-items-center mb-4">
                            <h2 class="h5 mb-0 text-gray-1000">Dashboard - {{ $tahun_terpilih }}</h2>
                            <form method="GET" action="{{ route('karyawan.dashboard') }}" class="ml-3">
                        ...
                        <div>
                            <a href="/karyawan/export-excel?tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="/karyawan/medical" style="text-decoration: none;">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="/karyawan/perjalanan-bisnis" style="text-decoration: none;">
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    {{ $totalReimbursementPerjalananBisnis }} </div>
                                            </div>
                                            <div class="col-auto">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="/karyawan/penunjang-kantor" style="text-decoration: none;">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($reimbursements as $reimbursement)
                                                    <tr>
                                                        ...
                                                        <td>{{ \Carbon\Carbon::parse($reimbursement->tanggal_reimbursement)->format('d-m-Y') }}
                                                        </td>
                                                        <td>{{ number_format($reimbursement->total, 0, ',', '.') }}
                                                        </td>
                                                        <td>
                                                            @php
                                                                $nama_status_pengajuan = !is_null($reimbursement->nama_status_pengajuan_ky) ? $reimbursement->nama_status_pengajuan_ky : (!is_null($reimbursement->nama_status_pengajuan_mk) ? $reimbursement->nama_status_pengajuan_mk : $reimbursement->nama_status_pengajuan);
                                                                $btnClass = '';
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-gray-800">Total Pengajuan Reimbursement
                                    </h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-gray-800">Status Reimbursement</h6>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <span class="mr-2 small text-xs">
                                            <i class="fas fa-circle text-success"></i>Setuju
                                        </span>
                                        <span class="mr-2 small text-xs">
                                            <i class="fas fa-circle text-info"></i>Revisi
                                        </span>
                                        <span class="mr-2 small text-xs">
                                            <i class="fas fa-circle text-danger"></i>Tolak
                                        </span>
                                        <span class="mr-2 small text-xs">
                                            <i class="fas fa-circle text-primary"></i>Selesai
                                        </span>
                                        <span class="mr-2 small text-xs">
                                            <i class="fas fa-circle" style="color: #2ea564;"></i>Sesuai
                                        </span>
                                        <span class="mr-2 small text-xs">
                                            <i class="fas fa-circle" style="color: #b53643;"></i>TidakSesuai
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid" style="max-width: 100%; height: auto;"
                                            src="{{ asset('template/img/FormulirReimbursement.png') }}">
                                    </div>
                                    <p>Alur Pengajuan Reimbursement:</p>
                                    <ol>
                                        <li>Karyawan login</li>
                                        <li>Karyawan memilih jenis reimbursement</li>
                                        <li>Karyawan melakukan pengisian formulir reimbursement</li>
                                        <li>Karyawan melakukan pengajuan reimbursement</li>
                                        <li>Karyawan menunggu verifikasi dari kepala divisi</li>
                                        <li>
                                            Jika kepala divisi menyetujui pengajuan reimbursement maka akan lanjut ke
                                            tahap verifikasi manajer keuangan, dan jika tidak maka proses pengajuan
                                            reimbursement telah selesai. Apabila kepala divisi melakukan verifikasi
                                            dengan revisi maka reimbursement akan dilakukan untuk diupdate oleh
                                            Karyawan.
                                        </li>

                                        <li>Karyawan menunggu verifikasi dari manajer keuangan jika reimbursement
                                            disetujui kepala divisi</li>
                                        <li>
                                            Jika manajer keuangan menyetujui pengajuan reimbursement maka proses
                                            reimburse akan berlangsung, dan jika tidak maka proses telah selesai.
                                            Apabila Manajer Keuangan melakukan verifikasi
                                            dengan revisi maka reimbursement akan dilakukan untuk diupdate oleh
                                            Karyawan.
                                        </li>
                                    </ol>
...
<script>
    ...
    var myPieChart = new Chart(ctx, {
        type: 'doughnut',
        data: {
            labels: ["Menunggu ", "Setuju ", "Revisi ", "Tolak ", "Selesai ", "Sesuai ", "TidakSesuai "],
            datasets: [{
                data: [<?= $percentageMenungguKaryawan ?>,
                ...
                backgroundColor: ['#F6C23E', '#1CC88A', '#36B9CC', '#E74A3B', '#4E73DF', '#2ea564',
                    '#b53643',
                ],
                hoverBackgroundColor: ['#FFBF1E', '#00CE84', '#12BAD2', '#DA3B2C', '#365ED4', '#209655',
                    '#781923'
                ],
