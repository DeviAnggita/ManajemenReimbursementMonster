...
<head>
    ...
    <title>Update Reimbursement Penunjang Kantor</title>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="font-weight-bold text-gray-900">
                                ...
                                Update Pengajuan Reimbursement Penunjang
                                Kantor
                            </h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('kpenunjang-kantor.update', $reimbursement->id_reimbursement) }}"
                                ...
                                <div class="form-group" style="display: none;">
                                    <label for="id_user" style="color: black; width: 100%;">Nama Karyawan</label>
                                ...
                                <div class="form-group">
                                    <label for="tanggal_bayar" style="color: black; width: 100%;">Tanggal Bayar</label>
                                ...
                                <div class="form-group">
                                    <label for="keterangan" style="color: black; width: 100%;">Deskripsi</label>
                                ...
                                <div class="form-group">
                                    <label for="total" style="color: black; width: 100%;">Total</label>
                                ...
                                @foreach ($newLampirans as $index => $lampiran)
                                    ...
                                    <script>
                                        ...
                                        function deleteLampiran(lampiranId, ajaxIndex) {
                                            ...
                                            xhr.open('DELETE', '/hapus-lampiran-kpenunjang-kantor', true);
