                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('kpenunjang-kantor.index') }}" class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/karyawan/penunjang-kantor-export-excel"
                                    class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" id="exportButton">
                                    <i class="fas fa-download fa-sm text-white-50"></i> Download Excel by All
                                </a>
                            </div>
                        ...
                        <script>
                            function sortDataAndExportToExcel() {
                                ...
                                table.querySelectorAll('tbody tr').forEach(row => {
                                    ...
                                    const nama_supplier = row.querySelector('td:nth-child(3) span').textContent;
                                    const tanggal_reimbursement = row.querySelector('td:nth-child(4)').textContent;
                                    const total = row.querySelector('td:nth-child(5)').textContent;
                                    const nama_status_pengajuan = row.querySelector('td:nth-child(6) a').getAttribute('title');
                                ...
                                const filename = `Data Reimbursement Penunjang Kantor_${uniqueNumber}.xlsx`;
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Riwayat Reimbursement Penunjang Kantor
                            </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTablePenunjangKantorKaryawan" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if (in_array($reimbursement->id_status_pengajuan_ky, [42, 6, 5]))
                                                        ...
                                                        @include('Karyawan.penunjang-kantor.updateStatus')
                                                    @endif
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    <a href="{{ route('kpenunjang-kantor.show', $reimbursement->id_reimbursement) }}"
                                                    ...
                                                    {{-- MODAL SHOW PEGAWAI --}}
                                                    @include('Karyawan.penunjang-kantor.showVerifikasi')
                                                    ...
                                                    @if (in_array($reimbursement->id_status_pengajuan, $allowedUpdate->pluck('id_status_pengajuan')->toArray()) ||
                                                        ...
                                                        <a href="{{ route('kpenunjang-kantor.edit', $reimbursement->id_reimbursement) }}"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-target="#deleteModalKPenunjangKantor{{ $reimbursement->id_reimbursement }}"><i
                                                            class="fas fa-trash"></i></button>
                                                    {{-- MODAL DELETE Supplier --}}
                                                    @include('Karyawan.penunjang-kantor.delete')
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
