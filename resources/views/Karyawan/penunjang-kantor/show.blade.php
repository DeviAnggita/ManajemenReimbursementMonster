...
<head>
    ...
    <title>Detail Reimbursement Penunjang Kantor</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        {{-- <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Detail Reimbursement Penunjang Kantor</h6>
                        </div> --}}

                        <div class="card-header py-3">
                            <h6 class="font-weight-bold text-gray-900">
                                <a href="/karyawan/penunjang-kantor" class="arrow-link">
                                    <i class="fa fa-arrow-left" aria-hidden="true"></i>
                                </a>
                                Detail Reimbursement Penunjang Kantor
                            </h6>
                        </div>
                            ...
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control-plaintext mb-1"
                                        ...
                                        style="color: #1f1f1f; width: 300px;" value="{{ $lamp->nama_supplier ?? '' }}"
                                        readonly>
                                </div>
                            </div>
                            <div class="form-group mb-1 row">
                                <label class="col-sm-3 col-form-label" style="color: black; width: 25%;">Tanggal Bayar
                                </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control-plaintext mb-1"
                                        aria-describedby="id_reimbursement" name="id_reimbursement"
                            ...
                            <div class="form-group mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control-plaintext mb-1"
                                        aria-describedby="id_reimbursement" name="id_reimbursement"
                                        style="color: #1f1f1f; width: 300px;"
                                        value="{{ \Carbon\Carbon::parse($reimbursement->tanggal_reimbursement)->format('d-m-Y') }}"readonly>
                                </div>
                            </div>
                            <div class="form-group mb-1 row">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            @foreach ($lampirans as $index => $lampiran)
                                <div class="card-header py-3 mt-1">
                                    <h6 class="m-0 font-weight-bold text-gray-900"
                                        style="margin-top: 10px; margin-bottom: 10px;">
                                        Detail Lampiran Reimbursement {{ $index + 1 }}
                                    </h6>
                                </div>
                                ...
                                <div class="form-group mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control-plaintext mb-1"
                                            ...
                                            style="color: #1f1f1f; width: 300px;" value="{{ $lampiran->keterangan }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="form-group mb-1 row">
