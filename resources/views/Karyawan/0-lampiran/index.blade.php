...
<head>
    ...
    <title>Karyawan - Data Lampiran</title>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                @include('Karyawan.lampiran.create')
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                ...
                                                {{-- MODAL SHOW SUPPLIER --}}
                                                @include('Karyawan.lampiran.show')
                                                ...
                                                @include('Karyawan.lampiran.update')
                                                ...
                                                @include('Karyawan.lampiran.delete')
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
