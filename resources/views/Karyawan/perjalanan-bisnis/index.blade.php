                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="col">
                            ...
                            <div class="row mb-2">
                                <div class="d-flex align-items-center mb-4 ml-3">
                                    ...
                                    <form method="GET" action="{{ route('kperjalanan-bisnis.index') }}"
                                        class="ml-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-xl-12 col-auto mb-3 text-right">
                                <a href="/karyawan/perjalanan-bisnis-export-excel?bulan={{ $bulan_terpilih }}&tahun={{ $tahun_terpilih }}"
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Riwayat Reimbursement Perjalanan Bisnis
                            </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <!-- KONTEN -->
                                <table class="table table-bordered" id="dataTablePerjalananBisnisKaryawan"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if (in_array($reimbursement->id_status_pengajuan_ky, [42, 6, 5]))
                                                        ...
                                                        @include('Karyawan.perjalanan-bisnis.updateStatus')
                                                    @endif
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    <a href="{{ route('kperjalanan-bisnis.show', $reimbursement->id_reimbursement) }}"
                                                    ...
                                                    {{-- MODAL SHOW PEGAWAI --}}
                                                    @include('Karyawan.perjalanan-bisnis.showVerifikasi')
                                                    ...
                                                    @if (in_array($reimbursement->id_status_pengajuan, $allowedUpdate->pluck('id_status_pengajuan')->toArray()) ||
                                                        ...
                                                        <a href="{{ route('kperjalanan-bisnis.edit', $reimbursement->id_reimbursement) }}"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-target="#deleteModalKPerjalananBisnis{{ $reimbursement->id_reimbursement }}"><i
                                                            class="fas fa-trash"></i></button>
                                                    {{-- MODAL DELETE Supplier --}}
                                                    @include('Karyawan.perjalanan-bisnis.delete')
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
