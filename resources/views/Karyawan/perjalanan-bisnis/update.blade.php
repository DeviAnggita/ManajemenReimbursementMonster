...
<head>
    ...
    <title>Update Reimbursement Perjalanan Bisnis</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        {{-- <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Update Pengajuan Reimbursement Perjalanan
                                Bisnis</h6>
                        </div> --}}
                        ...
                        <div class="card-header py-3">
                            <h6 class="font-weight-bold text-gray-900">
                                ...
                                Update Pengajuan Reimbursement Perjalanan Bisnis
                            </h6>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <form action="{{ route('kperjalanan-bisnis.update', $reimbursement->id_reimbursement) }}"
                                ...
                                <div class="form-group" style="display: none;" style="color: black; width: 25%;">
                                ...
                                @foreach ($newLampirans as $index => $lampiran)
                                    ...
                                    <script>
                                        ...
                                        function deleteLampiran(lampiranId, ajaxIndex) {
                                            ...
                                            xhr.open('DELETE', '/hapus-lampiran-kperjalanan-bisnis', true);
                                    ...
                                    <div class="form-group mb-1 row">
                                        <label class="col-sm-2 col-form-label"
                                            style="color: black; width: 100%;">Nomor
                                            Lampiran</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control mb-1"
                                    ...
                                    <div class="form-group mb-1 row">
                                        <label class="col-sm-2 col-form-label"
                                            style="color: black; width: 100%;">Tanggal Lampiran</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group mb-1 row">
                                        <label class="col-sm-2 col-form-label"
                                            style="color: black; width: 100%;">Judul Lampiran</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class=" form-group mb-1 row">
                                        <label class="col-sm-2 col-form-label" style="color: black; width: 100%;">Nama
                                            Lampiran</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control mb-1"
