...
class ReimbursementSKExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    use Exportable;
    ...
    public function collection()
    {
        ...
        $data = DB::table('tb_reimbursement')
            ...
            ->leftJoin('tb_status_pengajuan', 'tb_reimbursement.id_status_pengajuan_sk', '=', 'tb_status_pengajuan.id_status_pengajuan')
            ...
            ->whereIn('tb_status_pengajuan.id_status_pengajuan', [46,45])
