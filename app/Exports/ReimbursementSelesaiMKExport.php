...
class ReimbursementSelesaiMKExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    use Exportable;
    ...
    public function collection()
    {
        ...
        $query = DB::table('tb_reimbursement')
                ...
                ->whereIn('tb_status_pengajuan_ky.id_status_pengajuan', [17])
