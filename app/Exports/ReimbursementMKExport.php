...
class ReimbursementMKExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    use Exportable;
    ...
    public function collection()
    {
        ...
        $data = DB::table('tb_reimbursement')
            ...
            ->whereIn('tb_status_pengajuan.id_status_pengajuan', [21,10,9,26,35,8,17])
