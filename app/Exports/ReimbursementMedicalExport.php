...
class ReimbursementMedicalExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    use Exportable;
    ...
    public function collection()
    {
        ...
        ->where('tb_reimbursement.id_jenis_reimbursement', '=', 1) // Tambahkan klausa where
