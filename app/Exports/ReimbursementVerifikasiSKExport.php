...
class ReimbursementVerifikasiSKExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    use Exportable;
    ...
    public function collection()
    {
        $query = DB::table('tb_reimbursement')
            ...
            ->whereIn('tb_status_pengajuan_sk.id_status_pengajuan', [46])
