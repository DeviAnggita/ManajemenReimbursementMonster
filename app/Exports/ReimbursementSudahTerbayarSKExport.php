...
class ReimbursementSudahTerbayarSKExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    use Exportable;
    ...
    public function collection()
    {
        $query = DB::table('tb_reimbursement')
            ...
            ->whereIn('tb_status_pengajuan_sk.id_status_pengajuan', [45])
            ->whereIn('tb_status_pengajuan_ky.id_status_pengajuan', [42])
