...
use App\Exports\ReimbursementMedicalKaryawanExport;

use Illuminate\Support\Facades\Mail;

class MedicalKaryawanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('karyawan.medical.index', compact(
            'allowedUpdate',
            'allowedStatus',
            'reimbursements', 
            'bulan_terpilih',
    ...
    public function show($id_reimbursement)
    {
        ...
        return view('karyawan.medical.show', compact('reimbursement', 'lampirans', 'lampiranCount'));
    }
    ...
    public function showVerifikasi($id_reimbursement)
    {
        ...
        return view('karyawan.medical.showVerifikasi', compact('reimbursement', 'userVerifikasiKD', 'userVerifikasiMK'));
    }
    ...
    public function edit($id_reimbursement)
    {
        ...
        // dd($newLampirans);
        return view('karyawan.medical.update', compact('reimbursement','countlampirans', 'jenisReimbursement', 'supplier', 'user', 'lampirans','lampiran','proyek' ,'newLampirans'));
    }
    ...
    public function update(Request $request, $id_reimbursement)
    {
                        ...
                        if (in_array($extension, $allowedExtensions)) {
                         ...
                         if ($index === 1 || $index === 2) {
                            if (
                                ...
                                return redirect()
                                    ->route('kmedical.edit', ['id_reimbursement' => $id_reimbursement])
                                    ->withInput()
                                    ->with([
        ...
        return redirect()->route('kmedical.index', $reimbursementId)->with('success', 'Reimbursement Medical berhasil diperbarui.');
    }
    ...
    public function updateStatus(Request $request, $id_reimbursement)
    {
        ...
        return redirect()->route('kmedical.index')->with('success', 'Data berhasil diperbarui');
    }
    ...
    public function exportExcel(Request $request)
    {
        ...
        try {
            return Excel::download(new ReimbursementMedicalKaryawanExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
        } catch (\Exception $e) {
