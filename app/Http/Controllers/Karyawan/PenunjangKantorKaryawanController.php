...
use App\Exports\ReimbursementPenunjangKantorKaryawanExport;

use Illuminate\Support\Facades\Mail;


class PenunjangKantorKaryawanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('karyawan.penunjang-kantor.index', compact(
            'allowedUpdate',
            'allowedStatus',
            'lampirans',
            'reimbursements',
    ...
    public function show($id_reimbursement)
    {
        ...
        return view('karyawan.penunjang-kantor.show', compact('reimbursement', 'lamp','lampirans', 'lampiranCount'));
    }
    ...
    public function showVerifikasi($id_reimbursement)
    {
        ...
        return view('karyawan.penunjang-kantor.showVerifikasi', compact('reimbursement', 'userVerifikasiKD', 'userVerifikasiMK'));
    }
    ...
    public function edit($id_reimbursement)
    {
        ...
        // dd($newLampirans);
        return view('karyawan.penunjang-kantor.update', compact('reimbursement', 'jenisReimbursement', 'supplier', 'user', 'lampirans','lampiran','proyek' ,'newLampirans'));
    }
    ...
    public function update(Request $request, $id_reimbursement)
    {
        ...
        return redirect()->route('kpenunjang-kantor.index', $reimbursementId)->with('success', 'Reimbursement Penunjang Kantor berhasil diperbarui.');
    }
    ...
    public function updateStatus(Request $request, $id_reimbursement)
    {
        ...
        return redirect()->route('kpenunjang-kantor.index')->with('success', 'Data berhasil diperbarui');
    }
    ...
    public function sendEmail($receiver, $subject, $body, $body2, $body3, $body4, $body5,$body6)
    {
        if ($this->isOnline()) {
            ...
            Mail::send('Karyawan.penunjang-kantor.email', $email, function ($message) use ($email) {
    ...
    public function exportExcel(Request $request)
    {
        ...
        try {
            return Excel::download(new ReimbursementPenunjangKantorKaryawanExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
        } catch (\Exception $e) {
