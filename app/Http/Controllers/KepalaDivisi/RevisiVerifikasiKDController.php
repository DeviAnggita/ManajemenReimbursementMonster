...
use App\Exports\ReimbursementRevisiKDExport;

use Illuminate\Support\Facades\Mail;



class RevisiVerifikasiKDController extends Controller
{
    public function index(Request $request)
    {
            ...
            ->orderByRaw("GREATEST(tb_reimbursement.created_at, tb_reimbursement.updated_at) DESC")
            ...
            //Untuk status yang boleh di ubah Kepala Divisi
            ...
            return view('KepalaDivisi.revisi-verifikasi.index', compact(
                'allowedStatus',
                'reimbursements',
                'status_pengajuans',
                'bulan_terpilih',
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('KepalaDivisi.revisi-verifikasi.show', compact('reimbursement', 'lampirans','lamp1','lamp2','lampiranCount'));
        }
        ...
        public function update(Request $request, $id_reimbursement)
        {
            ...
            return redirect()->route('revisi-verifikasi-kd.index')->with('success', 'Data berhasil diperbarui');
        }
        ...
        public function sendEmail($receiver, $subject, $body, $body2, $body3, $body4)
        {
            if ($this->isOnline()) {
                ...
                Mail::send('KepalaDivisi.revisi-verifikasi.email', $email, function ($message) use ($email) {
        ...
        public function exportExcel(Request $request)
        {
            ...
            $uniqueNumber = time();
            $fileName = 'Data Reimbursement Setuju_' . $bulan_terpilih . '_' . $tahun_terpilih . '_' . $uniqueNumber . '.xlsx';
            
            try {
                return Excel::download(new ReimbursementRevisiKDExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
