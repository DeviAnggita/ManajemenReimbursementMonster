...
use App\Exports\ReimbursementSetujuKDExport;
use Illuminate\Support\Facades\Mail;



class SetujuVerifikasiKDController extends Controller
{
    public function index(Request $request)
    {
            ...
            ->whereIn('sp_mk.id_status_pengajuan', [41])
            ...
            return view('KepalaDivisi.setuju-verifikasi.index', compact(
                'allowedStatus',
                'reimbursements', 
                'status_pengajuans',
                'bulan_terpilih',
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('KepalaDivisi.setuju-verifikasi.show', compact('reimbursement', 'lampirans','lamp1','lamp2','lampiranCount'));
        }
        ...
        public function update(Request $request, $id_reimbursement)
        {
            ...
            return redirect()->route('setuju-verifikasi-kd.index')->with('success', 'Data berhasil diperbarui');
        }
        ...
        public function sendEmail($receiver, $subject, $body, $body2, $body3, $body4)
        {
            if ($this->isOnline()) {
                ...
                Mail::send('KepalaDivisi.setuju-verifikasi.email', $email, function ($message) use ($email) {
        ...
        public function exportExcel(Request $request)
        {
            ...
            try {
                return Excel::download(new ReimbursementSetujuKDExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
