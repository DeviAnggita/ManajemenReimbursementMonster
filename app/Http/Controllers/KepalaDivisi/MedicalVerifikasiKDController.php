...
use App\Exports\ReimbursementMedicalKDExport;
use Illuminate\Support\Facades\Mail;


class MedicalVerifikasiKDController extends Controller
{
    public function index(Request $request)
    {
            ...
            return view('KepalaDivisi.medical-verifikasi.index', compact(
                'allowedStatus',
                'reimbursements',
                'status_pengajuans',
                'bulan_terpilih',
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('KepalaDivisi.medical-verifikasi.show', compact('reimbursement', 'lampirans','lamp1','lamp2','lampiranCount'));
        }
        ...
        public function update(Request $request, $id_reimbursement)
        {
            ...
            return redirect()->route('medical-verifikasi-kd.index')->with('success', 'Data berhasil diperbarui');
        }
        ...
        public function sendEmail($receiver, $subject, $body, $body2, $body3, $body4)
        {
            if ($this->isOnline()) {
                ...
                Mail::send('KepalaDivisi.medical-verifikasi.email', $email, function ($message) use ($email) {
        ...
        public function exportExcel(Request $request)
        {
            ...
            try {
                return Excel::download(new ReimbursementMedicalKDExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
