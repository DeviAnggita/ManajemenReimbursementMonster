...
use App\Exports\ReimbursementPerjalananBisnisKDExport;

use Illuminate\Support\Facades\Mail;


class PerjalananBisnisVerifikasiKDController extends Controller
{
    public function index(Request $request)
    {
            ...
            return view('KepalaDivisi.perjalanan-bisnis-verifikasi.index', compact(
                'allowedStatus', 
                'lampirans',
                'reimbursements', 
                'status_pengajuans',
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('KepalaDivisi.perjalanan-bisnis-verifikasi.show', compact('reimbursement', 'lampirans','lamp1','lamp2','lampiranCount'));
        }
        ...
        public function update(Request $request, $id_reimbursement)
        {
            ...
            return redirect()->route('perjalanan-bisnis-verifikasi-kd.index')->with('success', 'Data berhasil diperbarui');
        }
        ...
        public function sendEmail($receiver, $subject, $body, $body2, $body3, $body4)
        {
            if ($this->isOnline()) {
                ...
                Mail::send('KepalaDivisi.perjalanan-bisnis-verifikasi.email', $email, function ($message) use ($email) {
        ...
        //     return Excel::download(new ReimbursementPerjalananBisnisKDExport, $fileName);
        // }
        ...
        //     return Excel::download(new ReimbursementPerjalananBisnisKDExport($bulan_terpilih, $tahun_terpilih), $fileName);
        // }
        ...
        public function exportExcel(Request $request)
        {
            ...
            try {
                return Excel::download(new ReimbursementPerjalananBisnisKDExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
