...
class SupplierKDController extends Controller
{
    ...
    public function index()
    {
        ...
        ->get();
        return view('kepaladivisi/supplier.index', compact('suppliers'));
    }
    ...
    public function show($id_supplier)
    {
        ...
        return view('kepaladivsi/supplier.show', compact('suppliers'));
    }
