...
use App\Exports\ReimbursementVerifikasiKDExport;


class VerifikasiKDController extends Controller
{
    public function index(Request $request)
    {
            ...
            $reimbursements = DB::table('tb_reimbursement')
                ...
                ->whereIn('tb_status_pengajuan.id_status_pengajuan', [28,34])
                ...
                $allowedStatus = DB::table('tb_status_pengajuan')
                    ...
                    ->get();
                // dd($allowedStatus);
                return view('KepalaDivisi.verifikasi.index', compact(
                    'allowedStatus', 
                    'reimbursements',
                    'status_pengajuans',
                    'bulan_terpilih',
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('KepalaDivisi.verifikasi.show', compact('reimbursement', 'lampirans','lamp1','lamp2','lampiranCount'));
        }
        ...
        public function update(Request $request, $id_reimbursement)
        {
            ...
            return redirect()->route('verifikasi-kd.index')->with('success', 'Data berhasil diperbarui');
        }
        ...
        public function sendEmail($receiver, $subject, $body, $body2, $body3, $body4)
        {
            if ($this->isOnline()) {
                ...
                Mail::send('KepalaDivisi.verifikasi.email', $email, function ($message) use ($email) {
        ...
        public function exportExcel(Request $request)
        {
            ...
            try {
                return Excel::download(new ReimbursementVerifikasiKDExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
