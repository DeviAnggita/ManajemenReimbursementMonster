...
class LampiranKDController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kepaladivisi/lampiran.index', compact('lampirans', 'reimbursements', 'suppliers','jenis_reimbursements'));
    }
    ...
    public function create()
    {
        ...
        $suppliers = Supplier::get();
        $jenis_reimbursements = JenisReimbursement::get();
        return view('kepaladivisi/lampiran.create', compact('reimbursements, suppliers, jenis_reimbursements'));
    }
    ...
    public function show($id_lampiran)
    {
        ...
        return view('kepaladivisi/lampiran.show', compact('lampirans'));
    }
