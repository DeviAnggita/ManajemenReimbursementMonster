...
use App\Exports\ReimbursementPerjalananBisnisExport;
use Maatwebsite\Excel\Facades\Excel;


class PerjalananBisnisController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('superadmin.perjalanan-bisnis.index', compact(
            'lampirans',
            'reimbursements',
            'allowedUpdate',
            'bulan_terpilih',
            ...
            'tahun_terpilih',
            'tahun_options'
            // 'nama_karyawan_terpilih',
            // 'nama_karyawan_options'
        ));
    }
    ...
    public function show($id_reimbursement)
    {
        ...
        // dd($lamp);
        return view('superadmin.perjalanan-bisnis.show', compact('reimbursement','lamp', 'lampirans', 'lampiranCount','userVerifikasiKD' ,'userVerifikasiMK'));
    }
    ...
    public function showVerifikasi($id_reimbursement)
    {
        ...
        return view('superadmin.perjalanan-bisnis.showVerifikasi', compact('reimbursement', 'userVerifikasiKD', 'userVerifikasiMK'));
    }
    ...
    public function edit($id_reimbursement)
    {
        ...
        // dd($newLampirans);
        return view('superadmin.perjalanan-bisnis.update', compact('reimbursement', 'jenisReimbursement', 'supplier', 'user','lampirans','lampiran','proyek' ,'newLampirans'));
    }
    ...
    public function update(Request $request, $id_reimbursement)
    {
       ...
       $reimbursement->save();
                    ...
                    $lampiran->id_reimbursement = $reimbursementId;
                        ...
                        if ($index === 1 || $index === 2) {
                            if (
                                ...
                                return redirect()
                                    ->route('perjalanan-bisnis.edit', ['id_reimbursement' => $id_reimbursement])
                                    ->withInput()
                                    ->with([
                                        Alert::error('Gagal', 'Data Reimbursement Perjalanan Bisnis Gagal Diperbarui')
                                    ]);
                            }
                        }
        ...
        return redirect()->route('perjalanan-bisnis.index', $reimbursementId)->with('success', 'Reimbursement Perjalanan Bisnis berhasil diperbarui.');
    }
    ...
    public function destroy($id_reimbursement)
    {
        ...
        if ($reimbursement) {
            return redirect()
                ...
                ->with([
                    Alert::success('Berhasil', 'Data Reimbursement Perjalanan Bisnis Berhasil Dihapus')
                ]);
        } else {
            return redirect()
            ->route('perjalanan-bisnis.index')
                ->with([
                    Alert::error('Gagal', 'Data Reimbursement Perjalanan Bisnis Gagal Dihapus')
                ]);
            }
    }
    ...
    public function exportExcel(Request $request)
    {
        ...
        try {
            return Excel::download(new ReimbursementPerjalananBisnisExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
        } catch (\Exception $e) {
