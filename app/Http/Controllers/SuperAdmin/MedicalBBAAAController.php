...
use App\Exports\ReimbursementMedicalExport;
...
class MedicalController extends Controller
{
        public function index(Request $request)
        {
            ...
            $reimbursements = DB::table('tb_reimbursement')
                ...
                return view('superadmin.medical.index', compact(
                    'reimbursements',
                    'allowedUpdate',
                    'bulan_terpilih',
                    'bulan_options',
        ...
        //     $bulan_options = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember'];
        //     $tahun_options = [2022, 2023, 2024, 2025, 2026, 2027, 2028]; // Replace with the appropriate year options
        ...
        //     // Filter by ID search
        //     if ($search) {
        //         $reimbursements->where('tb_reimbursement.nama_karyawan', '=', $search);
        //     }
        ...
        //         'tahun_terpilih',
        //         'tahun_options',
        //         'search' // Pass the search value to the view
        //     ));
        // }
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('superadmin.medical.show', compact('reimbursement', 'lampirans', 'lampiranCount','userVerifikasiKD' ,'userVerifikasiMK'));
        }
        ...
        public function showVerifikasi($id_reimbursement)
        {
            ...
            return view('superadmin.medical.showVerifikasi', compact('reimbursement', 'userVerifikasiKD', 'userVerifikasiMK'));
        }
        ...
        public function edit($id_reimbursement)
        {
            ...
            // dd($newLampirans);
            return view('superadmin.medical.update', compact('reimbursement', 'jenisReimbursement', 'supplier', 'user', 'lampirans','lampiran','proyek' ,'newLampirans'));
        }
        ...
        public function update(Request $request, $id_reimbursement)
        {
                        ...
                        // Validasi field yang harus diisi
                            if ($index === 1 || $index === 2) {
                                if (
                                    ...
                                    return redirect()
                                        ->route('medical.edit', ['id_reimbursement' => $id_reimbursement])
                                        ->withInput()
                                        ->with([
                                            Alert::error('Gagal', 'Data Reimbursement Medical Gagal Diperbarui')
                                        ]);
                                }
                            }
            ...
            return redirect()->route('medical.index', $reimbursementId)->with('success', 'Reimbursement Medical berhasil diperbarui.');
        }
        ...
        //     $bulan_terpilih = $request->input('bulan', 'all');
        //     $tahun_terpilih = $request->input('tahun', 'all');
        //     $search = $request->input('search.value'); // Get the search parameter from the DataTable's search value
        
        //     $uniqueNumber = time();
        //     $fileName = 'Data Reimbursement Medical_' . $bulan_terpilih . '_' . $tahun_terpilih . '_' . $uniqueNumber . '.xlsx';
        
        //     // Pass the search parameter to the export class
        //     return Excel::download(new ReimbursementMedicalExport($bulan_terpilih, $tahun_terpilih, $search), $fileName);
        // }
        ...
        public function exportExcel(Request $request)
        {
            ...
            // Pass the search parameter to the export class
            return Excel::download(new ReimbursementMedicalExport($bulan_terpilih, $tahun_terpilih), $fileName);
        }
