...
class MedicalController extends Controller
{
        ...
        //     $filteredData = DB::table('tb_reimbursement')
        //     ->when($search, function ($query, $search) {
        //         return $query->where(function ($query) use ($search) {
        //             $query->where('nama_karyawan', 'like', '%' . $search . '%')
        //                 ->orWhereDate('tanggal_reimbursement', '=', \Carbon\Carbon::parse($search)->toDateString())
        //                 ->orWhere('total', '=', str_replace('.', '', $search))
        //                 ->orWhere('nama_status_pengajuan', 'like', '%' . $search . '%');
        //         });
        //     })
        //     ->get();
        ...
        public function exportExcel(Request $request)
        {
            ...
            try {
                return Excel::download(new ReimbursementMedicalExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
