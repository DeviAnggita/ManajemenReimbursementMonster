...
use App\Exports\ReimbursementVerifikasiMKExport;


class VerifikasiMKController extends Controller
{
        public function index(Request $request)
        {
            ...
            return view('ManajerKeuangan.verifikasi.index', compact(
                'reimbursements', 
                'status_pengajuans',
                'bulan_terpilih',
                'bulan_options',
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('ManajerKeuangan.verifikasi.show', compact('reimbursement', 'lampirans','lamp1','lamp2','lampiranCount'));
        }
        ...
        public function update(Request $request, $id_reimbursement)
        {
            ...
            if ($reimbursement->id_status_pengajuan_mk == 8) {
                ...
                // $user = User::findOrFail($id_user) dengan id_role=5 ;
            ...
            return redirect()->route('verifikasi-mk.index')->with('success', 'Data berhasil diperbarui');
        }
        ...
        public function sendEmail($receiver, $subject, $body, $body2, $body3, $body4, $body5, $body6)
        {
            if ($this->isOnline()) {
                ...
                Mail::send('ManajerKeuangan.verifikasi.email', $email, function ($message) use ($email) {
        ...
        public function exportExcel(Request $request)
        {
            ...
            try {
                return Excel::download(new ReimbursementVerifikasiMKExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
