...
class ProfileMKController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('manajerkeuangan.profile.index', compact('karyawan', 'divisis', 'stratas', 'roles'));
    }
    ...
    //         Mail::send('ManajerKeuangan.profile.email', $email, function ($message) use ($email) {
