...
class LampiranMKController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('manajerkeuangan/lampiran.index', compact('lampirans', 'reimbursements', 'suppliers','jenis_reimbursements'));
    }
    ...
    public function create()
    {
        ...
        $suppliers = Supplier::get();
        $jenis_reimbursements = JenisReimbursement::get();
        return view('mananajerkeuangan/lampiran.create', compact('reimbursements, suppliers, jenis_reimbursements'));
    }
    ...
    public function show($id_lampiran)
    {
        ...
        return view('manajerkeuangan/lampiran.show', compact('lampirans'));
    }
