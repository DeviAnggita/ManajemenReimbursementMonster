...
use App\Exports\ReimbursementSelesaiMKExport;



class SelesaiReimbursementMKController extends Controller
{
    public function index(Request $request)
    {
            ...
            return view('ManajerKeuangan.selesai-reimbursement.index', compact(
                'reimbursements', 
                'status_pengajuans', 
                'bulan_terpilih',
                'bulan_options',
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('ManajerKeuangan.selesai-reimbursement.show', compact('reimbursement', 'lampirans','lamp1','lamp2','lampiranCount'));
        }
        ...
        public function exportExcel(Request $request)
        {
            ...
            try {
                return Excel::download(new ReimbursementSelesaiMKExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
