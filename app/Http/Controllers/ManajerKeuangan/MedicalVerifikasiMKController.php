...
use App\Exports\ReimbursementMedicalMKExport;

use Illuminate\Support\Facades\Mail;

class MedicalVerifikasiMKController extends Controller
{
    public function index(Request $request)
    {
            ...
            //Memanggil opsi nama status pengajuan
            ...
            return view('ManajerKeuangan.medical-verifikasi.index', compact(
                'reimbursements',  
                'status_pengajuans',
                'bulan_terpilih',
                'bulan_options',
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('ManajerKeuangan.medical-verifikasi.show', compact('reimbursement', 'lampirans','lamp1','lamp2','lampiranCount'));
        }
        ...
        public function update(Request $request, $id_reimbursement)
        {
            ...
            return redirect()->route('medical-verifikasi-mk.index')->with('success', 'Data berhasil diperbarui');
        }
        ...
        public function sendEmail($receiver, $subject, $body, $body2, $body3, $body4, $body5, $body6)
        {
            if ($this->isOnline()) {
                ...
                Mail::send('ManajerKeuangan.medical-verifikasi.email', $email, function ($message) use ($email) {
        ...
        public function exportExcel(Request $request)
        {
            ...
            try {
                return Excel::download(new ReimbursementMedicalMKExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
