...
use App\Exports\ReimbursementSetujuMKExport;

use Illuminate\Support\Facades\Mail;


class SetujuVerifikasiMKController extends Controller
{
    public function index(Request $request)
    {
        ...
        $reimbursements = DB::table('tb_reimbursement')
            ...
            ->whereIn('tb_reimbursement.id_status_pengajuan_mk', [8])
            ->whereIn('sp_sk.id_status_pengajuan', [46])
            ...
            //     if ($item->id_status_pengajuan_mk == 8) {
            //         // $limaHariKemudian = Carbon::parse($item->tanggal_verifikasi_mk, 'Asia/Jakarta')->addMinutes(1);
            //         $limaHariKemudian = Carbon::parse($item->tanggal_verifikasi_mk, 'Asia/Jakarta')->addDay(5);
        ...
        return view('ManajerKeuangan.setuju-verifikasi.index', compact(
            'reimbursements', 
            'status_pengajuans',
            'bulan_terpilih',
            'bulan_options',
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('ManajerKeuangan.setuju-verifikasi.show', compact('reimbursement', 'lampirans','lamp1','lamp2','lampiranCount'));
        }
        ...
        public function update(Request $request, $id_reimbursement)
        {
            ...
            return redirect()->route('setuju-verifikasi-mk.index')->with('success', 'Data berhasil diperbarui');
        }
        ...
        public function sendEmail($receiver, $subject, $body, $body2, $body3, $body4, $body5, $body6)
        {
            if ($this->isOnline()) {
                ...
                Mail::send('ManajerKeuangan.setuju-verifikasi.email', $email, function ($message) use ($email) {
        ...
        public function exportExcel(Request $request)
        {
            ...
            try {
                return Excel::download(new ReimbursementSetujuMKExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
