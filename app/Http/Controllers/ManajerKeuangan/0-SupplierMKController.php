...
class SupplierMKController extends Controller
{
    ...
    public function index()
    {
        ...
        ->get();
        return view('manajerkeuangan/supplier.index', compact('suppliers'));
    }
    ...
    public function show($id_supplier)
    {
        ...
        return view('manajerkeuangan/supplier.show', compact('suppliers'));
    }
