...
use App\Exports\ReimbursementTolakMKExport;

use Illuminate\Support\Facades\Mail;


class TolakVerifikasiMKController extends Controller
{
    public function index(Request $request)
    {
        ...
        for ($i = 0; $i < 5; $i++) {
            ...
            $reimbursements = DB::table('tb_reimbursement')
                ...
                ->whereIn('tb_reimbursement.id_status_pengajuan_mk', [9])
            ...
            return view('ManajerKeuangan.tolak-verifikasi.index', compact(
                'reimbursements',
                'status_pengajuans',
                'bulan_terpilih',
                'bulan_options',
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('ManajerKeuangan.tolak-verifikasi.show', compact('reimbursement', 'lampirans','lamp1','lamp2','lampiranCount'));
        }
        ...
        public function update(Request $request, $id_reimbursement)
        {
            ...
            return redirect()->route('tolak-verifikasi-mk.index')->with('success', 'Data berhasil diperbarui');
        }
        ...
        public function sendEmail($receiver, $subject, $body, $body2, $body3, $body4, $body5, $body6)
        {
            if ($this->isOnline()) {
                ...
                Mail::send('ManajerKeuangan.tolak-verifikasi.email', $email, function ($message) use ($email) {
        ...
        public function exportExcel(Request $request)
        {
            ...
            try {
                return Excel::download(new ReimbursementTolakMKExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
