...
use App\Exports\ReimbursementVerifikasiSKExport;


class VerifikasiSKController extends Controller
{
        public function index(Request $request)
        {
            ...
            $reimbursements = DB::table('tb_reimbursement')
                ...
                ->whereIn('tb_reimbursement.id_status_pengajuan_sk', [46])
            ...
            return view('StaffKeuangan.verifikasi.index', compact(
                'reimbursements', 
                'status_pengajuans',
                'bulan_terpilih',
                'bulan_options',
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('StaffKeuangan.verifikasi.show', compact('reimbursement', 'lampirans','lamp1','lamp2','lampiranCount'));
        }
        ...
        public function update(Request $request, $id_reimbursement)
        {
            ...
            return redirect()->route('verifikasi-sk.index')->with('success', 'Data berhasil diperbarui');
        }
        ...
        public function sendEmail($receiver, $subject, $body, $body2, $body3, $body4, $body5, $body6)
        {
            if ($this->isOnline()) {
                ...
                Mail::send('StaffKeuangan.verifikasi.email', $email, function ($message) use ($email) {
        ...
        public function exportExcel(Request $request)
        {
            ...
            try {
                return Excel::download(new ReimbursementVerifikasiSKExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
