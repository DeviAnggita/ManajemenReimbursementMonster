...
use App\Exports\ReimbursementPerjalananBisnisSKExport;

use Illuminate\Support\Facades\Mail;


class PerjalananBisnisVerifikasiSKController extends Controller
{
    public function index(Request $request)
    {
            ...
            $reimbursements = DB::table('tb_reimbursement')
                ...
                ->where('sp_sk.id_status_pengajuan', [45,46]) // Menambahkan kondisi where not in
            ...
            ->whereNotIn('tb_status_pengajuan.id_status_pengajuan', [46]) // Menambahkan kondisi where not in
            ->where('tb_status_pengajuan.hapus', '=', 0) //tidak terhapus
            ...
            return view('StaffKeuangan.perjalanan-bisnis-verifikasi.index', compact(
                'lampirans',
                'reimbursements',
                'status_pengajuans',
                'bulan_terpilih',
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('StaffKeuangan.perjalanan-bisnis-verifikasi.show', compact('reimbursement', 'lampirans','lamp1','lamp2','lampiranCount'));
        }
        ...
        public function update(Request $request, $id_reimbursement)
        {
            ...
            return redirect()->route('perjalanan-bisnis-verifikasi-sk.index')->with('success', 'Data berhasil diperbarui');
        }
        ...
        public function sendEmail($receiver, $subject, $body, $body2, $body3, $body4, $body5, $body6)
        {
            if ($this->isOnline()) {
                ...
                Mail::send('StaffKeuangan.perjalanan-bisnis-verifikasi.email', $email, function ($message) use ($email) {
        ...
        public function exportExcel(Request $request)
        {
            ...
            try {
                return Excel::download(new ReimbursementPerjalananBisnisSKExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
