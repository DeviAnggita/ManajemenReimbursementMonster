...
use App\Exports\ReimbursementMedicalSKExport;

use Illuminate\Support\Facades\Mail;

class MedicalVerifikasiSKController extends Controller
{
    public function index(Request $request)
    {
           ...
           ->get();
            ...
            return view('StaffKeuangan.medical-verifikasi.index', compact(
                'reimbursements',  
                'status_pengajuans',
                'bulan_terpilih',
                'bulan_options',
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('StaffKeuangan.medical-verifikasi.show', compact('reimbursement', 'lampirans','lamp1','lamp2','lampiranCount'));
        }
        ...
        public function update(Request $request, $id_reimbursement)
        {
            ...
            return redirect()->route('medical-verifikasi-sk.index')->with('success', 'Data berhasil diperbarui');
        }
        ...
        public function sendEmail($receiver, $subject, $body, $body2, $body3, $body4, $body5, $body6)
        {
            if ($this->isOnline()) {
                ...
                Mail::send('StaffKeuangan.medical-verifikasi.email', $email, function ($message) use ($email) {
        ...
        public function exportExcel(Request $request)
        {
            ...
            try {
                return Excel::download(new ReimbursementMedicalSKExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
