...
use App\Exports\ReimbursementPenunjangKantorSKExport;
...
class PenunjangKantorVerifikasiSKController extends Controller
{
    public function index(Request $request)
    {
            ...
            return view('StaffKeuangan.penunjang-kantor-verifikasi.index', compact(
                'lampirans',
                'reimbursements', 
                'status_pengajuans',
                'bulan_terpilih',
        ...
        public function show($id_reimbursement)
        {
            ...
            return view('StaffKeuangan.penunjang-kantor-verifikasi.show', compact('reimbursement', 'lampirans','lamp1','lamp2','lampiranCount'));
        }
        ...
        public function update(Request $request, $id_reimbursement)
        {
            ...
            return redirect()->route('penunjang-kantor-verifikasi-sk.index')->with('success', 'Data berhasil diperbarui');
        }
        ...
        public function sendEmail($receiver, $subject, $body, $body2, $body3, $body4, $body5, $body6)
        {
            if ($this->isOnline()) {
                ...
                Mail::send('StaffKeuangan.penunjang-kantor-verifikasi.email', $email, function ($message) use ($email) {
        ...
        public function exportExcel(Request $request)
        {
            ...
            try {
                return Excel::download(new ReimbursementPenunjangKantorSKExport($bulan_terpilih, $tahun_terpilih, $searchValue), $fileName);
            } catch (\Exception $e) {
